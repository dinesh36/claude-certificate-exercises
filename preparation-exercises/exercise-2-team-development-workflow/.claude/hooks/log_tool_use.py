#!/usr/bin/env python3
"""PostToolUse hook: logs every tool call this exercise's live sessions make.

Wired in this folder's own .claude/settings.json. Claude Code invokes this
script once per tool call, passing a JSON payload on stdin (tool_name,
...
log_path = repo_root / "logs" / "preparation-exercises" / "exercise-2-team-development-workflow.jsonl"

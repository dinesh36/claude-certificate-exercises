...
_get_order_details and _search_orders are deliberately similar — both
...
def _search_orders(customer_id: str, query: str = "") -> dict:
...
def _process_refund(order_id: str, amount: float, reason: str) -> dict:
    order = ORDERS.get(order_id)
    if order is None:
        return tool_error(
            "validation",
...
def _escalate_to_human(customer_id: str, issue_summary: str, root_cause: str, recommended_action: str, order_id: str = "") -> dict:
...
TOOLS = [
    {
        ...
        "implementation": _get_order_details,
    },
    {
        "schema": {
            "name": "search_orders",
    ...
    },
    {
        ...
        "implementation": _process_refund,
    },
    {
        "schema": {
        ...
        "implementation": _escalate_to_human,
    },
]

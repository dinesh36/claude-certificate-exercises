...
def _dispatch_analysis_subagent(topic_tag: str, summaries: list[str], focus: str) -> dict:
    if not summaries:
        return tool_error(
            "validation",
            False,
    ...
    analysis = run_subagent(_client, _model, ANALYSIS_SUBAGENT_SYSTEM, user_message)
...
TOOLS = [
    {
        ...
        "implementation": _dispatch_search_subagent,
    },
    {
        "schema": {
        ...
        "implementation": _dispatch_analysis_subagent,
    },
]

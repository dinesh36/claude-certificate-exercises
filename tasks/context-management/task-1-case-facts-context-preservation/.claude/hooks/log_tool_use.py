#!/usr/bin/env python3
"""PostToolUse hook: logs every tool call this task's live sessions make.
...
log_path = repo_root / "logs" / "context-reliability" / "task-1-case-facts-context-preservation.jsonl"
